...
```{r}
import <- data.frame(id=9999, name='Mirkos Station', elevation=2500, geometry="POINT(7.8 48.0)", description="My dummy station", discipline_id=99, hobo_id=99999, influence='super high')
