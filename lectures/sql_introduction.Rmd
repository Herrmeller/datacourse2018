...
The select is the most important operation for us, as we usually have complex structured data in the database and need very specific subsets of that data for analysis. 
